...
public class Scenario1FourPlayerSetup : IScenario1Setup
{
    ...
    [
        StandardTerrain.Forest, StandardTerrain.Forest, StandardTerrain.Forest, StandardTerrain.Forest,
        StandardTerrain.Pasture, StandardTerrain.Pasture, StandardTerrain.Pasture, StandardTerrain.Pasture,
        StandardTerrain.Fields, StandardTerrain.Fields, StandardTerrain.Fields, StandardTerrain.Fields,
        StandardTerrain.Hills, StandardTerrain.Hills, StandardTerrain.Hills,
        StandardTerrain.Mountains, StandardTerrain.Mountains, StandardTerrain.Mountains,
        StandardTerrain.Desert
    ];
    ...
    [
        StandardTerrain.Forest,
        StandardTerrain.Pasture,
        StandardTerrain.Fields,
        StandardTerrain.Hills, StandardTerrain.Hills,
        StandardTerrain.Mountains, StandardTerrain.Mountains,
        SeafarersTerrain.Sea, SeafarersTerrain.Sea, SeafarersTerrain.Sea, SeafarersTerrain.Sea,
        SeafarersTerrain.Gold, SeafarersTerrain.Gold
    ];
